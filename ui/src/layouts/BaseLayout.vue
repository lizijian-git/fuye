        ...
        <lay-logo v-if="appStore.logo">
          <div  class="logo-warpper">
            <!-- <div class="logo-pic"></div> -->
             <div class="display:flex;align-items:center;"><img src="https://yingdioss.oss-cn-shenzhen.aliyuncs.com/yingdioss/1680192509828_b69015a9"  class="logo-img"/></div> 
              <div v-if="sideWidth != '60px'">福业运营平台</div>
          </div>
...
export default {
  ...
  setup() {
    ...
    const sideWidth = computed(() =>
      appStore.collapse ? "60px" : (appStore.subfield && appStore.subfieldPosition == 'side') ? "280px" : "200px"
    );
...
/* .logo-pic{
  background-image: url(https://yingdioss.oss-cn-shenzhen.aliyuncs.com/yingdioss/1680192509828_b69015a9);
  width: 36px;
  height: 36px;
  border-radius: 50%;
